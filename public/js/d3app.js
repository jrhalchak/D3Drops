 ...
 */'use strict';var ReactDOM=_dereq_(35);var ReactDOMServer=_dereq_(45);var ReactIsomorphic=_dereq_(63);var assign=_dereq_(23);var deprecated=_dereq_(105); // `version` will be added here by ReactIsomorphic.
 ...
 * @typechecks static-only
 */'use strict';var EventConstants=_dereq_(15);var EventPropagators=_dereq_(19);var ExecutionEnvironment=_dereq_(129);var FallbackCompositionState=_dereq_(20);var SyntheticCompositionEvent=_dereq_(90);var SyntheticInputEvent=_dereq_(94);var keyOf=_dereq_(147);var END_KEYCODES=[9,13,27,32]; // Tab, Return, Esc, Space
 ...
 */'use strict';var PooledClass=_dereq_(24);var assign=_dereq_(23);var invariant=_dereq_(143); /**
 ...
 */function CallbackQueue(){this._callbacks=null;this._contexts=null;}assign(CallbackQueue.prototype,{ /**
   ...
   */destructor:function destructor(){this.reset();}});PooledClass.addPoolingTo(CallbackQueue);module.exports=CallbackQueue;},{"143":143,"23":23,"24":24}],7:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var Danger=_dereq_(12);var ReactMultiChildUpdateTypes=_dereq_(67);var ReactPerf=_dereq_(71);var setInnerHTML=_dereq_(123);var setTextContent=_dereq_(124);var invariant=_dereq_(143); /**
...
break;}}}};ReactPerf.measureMethods(DOMChildrenOperations,'DOMChildrenOperations',{updateTextContent:'updateTextContent'});module.exports=DOMChildrenOperations;},{"12":12,"123":123,"124":124,"143":143,"67":67,"71":71}],10:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var invariant=_dereq_(143);function checkMask(value,bitmask){return (value&bitmask)===bitmask;}var DOMPropertyInjection={ /**
 ...
 * @typechecks static-only
 */'use strict';var DOMProperty=_dereq_(10);var ReactPerf=_dereq_(71);var quoteAttributeValueForBrowser=_dereq_(121);var warning=_dereq_(154); // Simplified subset
 ...
 * @typechecks static-only
 */'use strict';var ExecutionEnvironment=_dereq_(129);var createNodesFromMarkup=_dereq_(134);var emptyFunction=_dereq_(135);var getMarkupWrap=_dereq_(139);var invariant=_dereq_(143);var OPEN_TAG_NAME_EXP=/^(<[^ \/>]+)/;var RESULT_INDEX_ATTR='data-danger-index'; /**
 ...
 */'use strict';var keyOf=_dereq_(147); /**
 ...
 */var DefaultEventPluginOrder=[keyOf({ResponderEventPlugin:null}),keyOf({SimpleEventPlugin:null}),keyOf({TapEventPlugin:null}),keyOf({EnterLeaveEventPlugin:null}),keyOf({ChangeEventPlugin:null}),keyOf({SelectEventPlugin:null}),keyOf({BeforeInputEventPlugin:null})];module.exports=DefaultEventPluginOrder;},{"147":147}],14:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var EventConstants=_dereq_(15);var EventPropagators=_dereq_(19);var SyntheticMouseEvent=_dereq_(96);var ReactMount=_dereq_(65);var keyOf=_dereq_(147);var topLevelTypes=EventConstants.topLevelTypes;var getFirstReactDOM=ReactMount.getFirstReactDOM;var eventTypes={mouseEnter:{registrationName:keyOf({onMouseEnter:null}),dependencies:[topLevelTypes.topMouseOut,topLevelTypes.topMouseOver]},mouseLeave:{registrationName:keyOf({onMouseLeave:null}),dependencies:[topLevelTypes.topMouseOut,topLevelTypes.topMouseOver]}};var extractedEvents=[null,null];var EnterLeaveEventPlugin={eventTypes:eventTypes, /**
 ...
 */'use strict';var keyMirror=_dereq_(146);var PropagationPhases=keyMirror({bubbled:null,captured:null}); /**
 ...
 */'use strict';var EventPluginRegistry=_dereq_(17);var EventPluginUtils=_dereq_(18);var ReactErrorUtils=_dereq_(56);var accumulateInto=_dereq_(102);var forEachAccumulated=_dereq_(109);var invariant=_dereq_(143);var warning=_dereq_(154); /**
...
ReactErrorUtils.rethrowCaughtError();}, /**
   ...
   */__purge:function __purge(){listenerBank={};},__getListenerBank:function __getListenerBank(){return listenerBank;}};module.exports=EventPluginHub;},{"102":102,"109":109,"143":143,"154":154,"17":17,"18":18,"56":56}],17:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var invariant=_dereq_(143); /**
 ...
 */'use strict';var EventConstants=_dereq_(15);var ReactErrorUtils=_dereq_(56);var invariant=_dereq_(143);var warning=_dereq_(154); /**
 ...
 */'use strict';var EventConstants=_dereq_(15);var EventPluginHub=_dereq_(16);var warning=_dereq_(154);var accumulateInto=_dereq_(102);var forEachAccumulated=_dereq_(109);var PropagationPhases=EventConstants.PropagationPhases;var getListener=EventPluginHub.getListener; /**
 ...
 */var EventPropagators={accumulateTwoPhaseDispatches:accumulateTwoPhaseDispatches,accumulateTwoPhaseDispatchesSkipTarget:accumulateTwoPhaseDispatchesSkipTarget,accumulateDirectDispatches:accumulateDirectDispatches,accumulateEnterLeaveDispatches:accumulateEnterLeaveDispatches};module.exports=EventPropagators;},{"102":102,"109":109,"15":15,"154":154,"16":16}],20:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var PooledClass=_dereq_(24);var assign=_dereq_(23);var getTextContentAccessor=_dereq_(116); /**
...
autoSave:null, // itemProp, itemScope, itemType are for
...
encType:'encoding',hrefLang:'hreflang',radioGroup:'radiogroup',spellCheck:'spellcheck',srcDoc:'srcdoc',srcSet:'srcset'}};module.exports=HTMLDOMPropertyConfig;},{"10":10,"129":129}],22:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ReactInstanceMap=_dereq_(62);var findDOMNode=_dereq_(107);var warning=_dereq_(154);var didWarnKey='_getDOMNodeDidWarn';var ReactBrowserComponentMixin={ /**
 ...
 * @typechecks static-only
 */'use strict';var EventConstants=_dereq_(15);var EventPluginHub=_dereq_(16);var EventPluginRegistry=_dereq_(17);var ReactEventEmitterMixin=_dereq_(57);var ReactPerf=_dereq_(71);var ViewportMetrics=_dereq_(101);var assign=_dereq_(23);var isEventSupported=_dereq_(118); /**
 ...
 * @typechecks static-only
 */'use strict';var ReactReconciler=_dereq_(76);var instantiateReactComponent=_dereq_(117);var shouldUpdateReactComponent=_dereq_(125);var traverseAllChildren=_dereq_(126);var warning=_dereq_(154);function instantiateChild(childInstances,child,name){ // We found a component instance.
 ...
 */'use strict';var ReactNoopUpdateQueue=_dereq_(69);var emptyObject=_dereq_(136);var invariant=_dereq_(143);var warning=_dereq_(154); /**
 ...
 */if("development"!=='production'){var deprecatedAPIs={getDOMNode:['getDOMNode','Use ReactDOM.findDOMNode(component) instead.'],isMounted:['isMounted','Instead, make sure to clean up subscriptions and pending requests in '+'componentWillUnmount to prevent memory leaks.'],replaceProps:['replaceProps','Instead, call render again at the top level.'],replaceState:['replaceState','Refactor your code to use setState instead (see '+'https://github.com/facebook/react/issues/3236).'],setProps:['setProps','Instead, call render again at the top level.']};var defineDeprecationWarning=function defineDeprecationWarning(methodName,info){try{Object.defineProperty(ReactComponent.prototype,methodName,{get:function get(){"development"!=='production'?warning(false,'%s(...) is deprecated in plain JavaScript React classes. %s',info[0],info[1]):undefined;return undefined;}});}catch(x){ // IE will fail on defineProperty (es5-shim/sham too)
}};for(var fnName in deprecatedAPIs){if(deprecatedAPIs.hasOwnProperty(fnName)){defineDeprecationWarning(fnName,deprecatedAPIs[fnName]);}}}module.exports=ReactComponent;},{"136":136,"143":143,"154":154,"69":69}],31:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var invariant=_dereq_(143);var injected=false;var ReactComponentEnvironment={ /**
 ...
 * @typechecks static-only
 */'use strict';var ReactElement=_dereq_(52);var ReactElementValidator=_dereq_(53);var mapObject=_dereq_(148); /**
 ...
 * @typechecks static-only
 */'use strict';var DOMChildrenOperations=_dereq_(9);var DOMPropertyOperations=_dereq_(11);var ReactMount=_dereq_(65);var ReactPerf=_dereq_(71);var invariant=_dereq_(143); /**
 ...
 */'use strict';var ReactDOMIDOperations=_dereq_(40);var LinkedValueUtils=_dereq_(22);var ReactMount=_dereq_(65);var ReactUpdates=_dereq_(83);var assign=_dereq_(23);var invariant=_dereq_(143);var instancesByReactID={};function forceUpdateIfMounted(){if(this._rootNodeID){ // DOM component is still mounted; update
...
// as appropriate.
ReactUpdates.asap(forceUpdateIfMounted,otherInstance);}}return returnValue;}module.exports=ReactDOMInput;},{"143":143,"22":22,"23":23,"40":40,"65":65,"83":83}],42:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ReactChildren=_dereq_(28);var ReactDOMSelect=_dereq_(43);var assign=_dereq_(23);var warning=_dereq_(154);var valueContextKey=ReactDOMSelect.valueContextKey; /**
 ...
 */'use strict';var LinkedValueUtils=_dereq_(22);var ReactMount=_dereq_(65);var ReactUpdates=_dereq_(83);var assign=_dereq_(23);var warning=_dereq_(154);var valueContextKey='__ReactDOMSelect_value$'+Math.random().toString(36).slice(2);function updateOptionsIfPendingUpdateAndMounted(){if(this._rootNodeID&&this._wrapperState.pendingUpdate){this._wrapperState.pendingUpdate=false;var props=this._currentElement.props;var value=LinkedValueUtils.getValue(props);if(value!=null){updateOptions(this,props,value);}}}function getDeclarationErrorAddendum(owner){if(owner){var name=owner.getName();if(name){return ' Check the render method of `'+name+'`.';}}return '';}var valuePropNames=['value','defaultValue']; /**
 ...
 */'use strict';var ExecutionEnvironment=_dereq_(129);var getNodeForCharacterOffset=_dereq_(115);var getTextContentAccessor=_dereq_(116); /**
...
if(!selection.extend&&start>end){var temp=end;end=start;start=temp;}var startMarker=getNodeForCharacterOffset(node,start);var endMarker=getNodeForCharacterOffset(node,end);if(startMarker&&endMarker){var range=document.createRange();range.setStart(startMarker.node,startMarker.offset);selection.removeAllRanges();if(start>end){selection.addRange(range);selection.extend(endMarker.node,endMarker.offset);}else {range.setEnd(endMarker.node,endMarker.offset);selection.addRange(range);}}}var useIEOffsets=ExecutionEnvironment.canUseDOM&&'selection' in document&&!('getSelection' in window);var ReactDOMSelection={ /**
   ...
   * @param {DOMElement|DOMTextNode} node
   * @param {object} offsets
   */setOffsets:useIEOffsets?setIEOffsets:setModernOffsets};module.exports=ReactDOMSelection;},{"115":115,"116":116,"129":129}],45:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var DOMChildrenOperations=_dereq_(9);var DOMPropertyOperations=_dereq_(11);var ReactComponentBrowserEnvironment=_dereq_(31);var ReactMount=_dereq_(65);var assign=_dereq_(23);var escapeTextContentForBrowser=_dereq_(106);var setTextContent=_dereq_(124);var validateDOMNesting=_dereq_(127); /**
 ...
 */'use strict';var LinkedValueUtils=_dereq_(22);var ReactDOMIDOperations=_dereq_(40);var ReactUpdates=_dereq_(83);var assign=_dereq_(23);var invariant=_dereq_(143);var warning=_dereq_(154);function forceUpdateIfMounted(){if(this._rootNodeID){ // DOM component is still mounted; update
...
if(alreadyBatchingUpdates){callback(a,b,c,d,e);}else {transaction.perform(callback,null,a,b,c,d,e);}}};module.exports=ReactDefaultBatchingStrategy;},{"100":100,"135":135,"23":23,"83":83}],49:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var DOMProperty=_dereq_(10);var ReactDefaultPerfAnalysis=_dereq_(51);var ReactMount=_dereq_(65);var ReactPerf=_dereq_(71);var performanceNow=_dereq_(151);function roundFloat(val){return Math.floor(val*100)/100;}function addValue(obj,key,val){obj[key]=(obj[key]||0)+val;}var ReactDefaultPerf={_allMeasurements:[], // last item in the list is the current one
 ...
 */'use strict';var ReactCurrentOwner=_dereq_(34);var assign=_dereq_(23); // The Symbol used to tag the ReactElement type. If there is no native Symbol
// nor polyfill, then a plain number is used for performance.
var REACT_ELEMENT_TYPE=typeof Symbol==='function'&&Symbol['for']&&Symbol['for']('react.element')||0xeac7;var RESERVED_PROPS={key:true,ref:true,__self:true,__source:true};var canDefineProperty=false;if("development"!=='production'){try{Object.defineProperty({},'x',{});canDefineProperty=true;}catch(x){ // IE will fail on defineProperty
}} /**
 ...
 * @final
 */ReactElement.isValidElement=function(object){return (typeof object==="undefined"?"undefined":_typeof(object))==='object'&&object!==null&&object.$$typeof===REACT_ELEMENT_TYPE;};module.exports=ReactElement;},{"23":23,"34":34}],53:[function(_dereq_,module,exports){ /**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * that support it.
 */'use strict';var ReactElement=_dereq_(52);var ReactPropTypeLocations=_dereq_(73);var ReactPropTypeLocationNames=_dereq_(72);var ReactCurrentOwner=_dereq_(34);var getIteratorFn=_dereq_(114);var invariant=_dereq_(143);var warning=_dereq_(154);function getDeclarationErrorAddendum(){if(ReactCurrentOwner.current){var name=ReactCurrentOwner.current.getName();if(name){return ' Check the render method of `'+name+'`.';}}return '';} /**
...
validatedFactory.type=type;if("development"!=='production'){try{Object.defineProperty(validatedFactory,'type',{enumerable:false,get:function get(){"development"!=='production'?warning(false,'Factory.type is deprecated. Access the class directly '+'before passing it to createFactory.'):undefined;Object.defineProperty(this,'type',{value:type});return type;}});}catch(x){ // IE will fail on defineProperty (es5-shim/sham too)
 ...
 * @typechecks static-only
 */'use strict';var EventListener=_dereq_(128);var ExecutionEnvironment=_dereq_(129);var PooledClass=_dereq_(24);var ReactInstanceHandles=_dereq_(61);var ReactMount=_dereq_(65);var ReactUpdates=_dereq_(83);var assign=_dereq_(23);var getEventTarget=_dereq_(113);var getUnboundedScrollPosition=_dereq_(140);var DOCUMENT_FRAGMENT_NODE_TYPE=11; /**
...
// `preventDefault`.
ReactUpdates.batchedUpdates(handleTopLevelImpl,bookKeeping);}finally {TopLevelCallbackBookKeeping.release(bookKeeping);}}};module.exports=ReactEventListener;},{"113":113,"128":128,"129":129,"140":140,"23":23,"24":24,"61":61,"65":65,"83":83}],59:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ReactDOMSelection=_dereq_(44);var containsNode=_dereq_(132);var focusNode=_dereq_(137);var getActiveElement=_dereq_(138);function isInDocument(node){return containsNode(document.documentElement,node);} /**
 ...
 * @typechecks static-only
 */'use strict';var ReactRootIndex=_dereq_(78);var invariant=_dereq_(143);var SEPARATOR='.';var SEPARATOR_LENGTH=SEPARATOR.length; /**
 ...
 */var ReactInstanceHandles={ /**
   ...
   * Exposed for unit testing.
   * @private
   */_getNextDescendantID:getNextDescendantID,isAncestorIDOf:isAncestorIDOf,SEPARATOR:SEPARATOR};module.exports=ReactInstanceHandles;},{"143":143,"78":78}],62:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
__spread:assign};module.exports=React;},{"120":120,"23":23,"28":28,"29":29,"30":30,"38":38,"52":52,"53":53,"74":74,"84":84}],64:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var ReactComponentEnvironment=_dereq_(32);var ReactMultiChildUpdateTypes=_dereq_(67);var ReactCurrentOwner=_dereq_(34);var ReactReconciler=_dereq_(76);var ReactChildReconciler=_dereq_(27);var flattenChildren=_dereq_(108); /**
...
var rootID=this._rootNodeID+name;var mountImage=ReactReconciler.mountComponent(child,rootID,transaction,context);child._mountIndex=index;this.createChild(child,mountImage);}, /**
     ...
     * @private
     */_unmountChild:function _unmountChild(child){this.removeChild(child);child._mountIndex=null;}}};module.exports=ReactMultiChild;},{"108":108,"27":27,"32":32,"34":34,"67":67,"76":76}],67:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var keyMirror=_dereq_(146); /**
 ...
 *
 * @internal
 */var ReactMultiChildUpdateTypes=keyMirror({INSERT_MARKUP:null,MOVE_EXISTING:null,REMOVE_NODE:null,SET_MARKUP:null,TEXT_CONTENT:null});module.exports=ReactMultiChildUpdateTypes;},{"146":146}],68:[function(_dereq_,module,exports){ /**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var assign=_dereq_(23);var invariant=_dereq_(143);var autoGenerateWrapperClass=null;var genericComponentClass=null; // This registry keeps track of wrapper classes around native tags.
 ...
 * @return {boolean}
 */function isTextComponent(component){return component instanceof textComponentClass;}var ReactNativeComponent={getComponentClassForElement:getComponentClassForElement,createInternalComponent:createInternalComponent,createInstanceForText:createInstanceForText,isTextComponent:isTextComponent,injection:ReactNativeComponentInjection};module.exports=ReactNativeComponent;},{"143":143,"23":23}],69:[function(_dereq_,module,exports){ /**
 ...
 */'use strict';var warning=_dereq_(154);function warnTDZ(publicInstance,callerName){if("development"!=='production'){"development"!=='production'?warning(false,'%s(...): Can only update a mounted or mounting component. '+'This usually means you called %s() on an unmounted component. '+'This is a no-op. Please check the code for the %s component.',callerName,callerName,publicInstance.constructor&&publicInstance.constructor.displayName||''):undefined;}} /**
 ...
 */var ReactNoopUpdateQueue={ /**
   ...
   * @internal
   */enqueueReplaceProps:function enqueueReplaceProps(publicInstance,props){warnTDZ(publicInstance,'replaceProps');}};module.exports=ReactNoopUpdateQueue;},{"154":154}],70:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
if(owner.getPublicInstance().refs[ref]===component.getPublicInstance()){owner.detachRef(ref);}}};module.exports=ReactOwner;},{"143":143}],71:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var keyMirror=_dereq_(146);var ReactPropTypeLocations=keyMirror({prop:null,context:null,childContext:null});module.exports=ReactPropTypeLocations;},{"146":146}],74:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ReactElement=_dereq_(52);var ReactPropTypeLocationNames=_dereq_(72);var emptyFunction=_dereq_(135);var getIteratorFn=_dereq_(114); /**
...
function getClassName(propValue){if(!propValue.constructor||!propValue.constructor.name){return '<<anonymous>>';}return propValue.constructor.name;}module.exports=ReactPropTypes;},{"114":114,"135":135,"52":52,"72":72}],75:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
// currently share these stateful modules.
ReactUpdates.injection.injectBatchingStrategy(ReactDefaultBatchingStrategy);}}module.exports={renderToString:renderToString,renderToStaticMarkup:renderToStaticMarkup};},{"117":117,"136":136,"143":143,"48":48,"52":52,"61":61,"64":64,"79":79,"81":81,"83":83}],81:[function(_dereq_,module,exports){ /**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var PooledClass=_dereq_(24);var CallbackQueue=_dereq_(6);var Transaction=_dereq_(100);var assign=_dereq_(23);var emptyFunction=_dereq_(135); /**
 ...
 */function asap(callback,context){!batchingStrategy.isBatchingUpdates?"development"!=='production'?invariant(false,'ReactUpdates.asap: Can\'t enqueue an asap callback in a context where'+'updates are not being batched.'):invariant(false):undefined;asapCallbackQueue.enqueue(callback,context);asapEnqueued=true;}var ReactUpdatesInjection={injectReconcileTransaction:function injectReconcileTransaction(ReconcileTransaction){!ReconcileTransaction?"development"!=='production'?invariant(false,'ReactUpdates: must provide a reconcile transaction class'):invariant(false):undefined;ReactUpdates.ReactReconcileTransaction=ReconcileTransaction;},injectBatchingStrategy:function injectBatchingStrategy(_batchingStrategy){!_batchingStrategy?"development"!=='production'?invariant(false,'ReactUpdates: must provide a batching strategy'):invariant(false):undefined;!(typeof _batchingStrategy.batchedUpdates==='function')?"development"!=='production'?invariant(false,'ReactUpdates: must provide a batchedUpdates() function'):invariant(false):undefined;!(typeof _batchingStrategy.isBatchingUpdates==='boolean')?"development"!=='production'?invariant(false,'ReactUpdates: must provide an isBatchingUpdates boolean attribute'):invariant(false):undefined;batchingStrategy=_batchingStrategy;}};var ReactUpdates={ /**
   ...
   *
   * @internal
   */ReactReconcileTransaction:null,batchedUpdates:batchedUpdates,enqueueUpdate:enqueueUpdate,flushBatchedUpdates:flushBatchedUpdates,injection:ReactUpdatesInjection,asap:asap};module.exports=ReactUpdates;},{"100":100,"143":143,"23":23,"24":24,"6":6,"71":71,"76":76}],84:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';module.exports='0.14.0';},{}],85:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
case topLevelTypes.topKeyDown:case topLevelTypes.topKeyUp:return constructSelectEvent(nativeEvent,nativeEventTarget);}return null;},didPutListener:function didPutListener(id,registrationName,listener){if(registrationName===ON_SELECT_KEY){hasListener=true;}}};module.exports=SelectEventPlugin;},{"119":119,"129":129,"138":138,"147":147,"15":15,"152":152,"19":19,"60":60,"92":92}],87:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var PooledClass=_dereq_(24);var assign=_dereq_(23);var emptyFunction=_dereq_(135);var warning=_dereq_(154); /**
 * @interface Event
 * @see http://www.w3.org/TR/DOM-Level-3-Events/
 ...
 * @typechecks static-only
 */'use strict';var SyntheticUIEvent=_dereq_(98);var getEventCharCode=_dereq_(110);var getEventKey=_dereq_(111);var getEventModifierState=_dereq_(112); /**
 ...
 * @typechecks static-only
 */'use strict';var SyntheticUIEvent=_dereq_(98);var ViewportMetrics=_dereq_(101);var getEventModifierState=_dereq_(112); /**
 ...
 * @typechecks static-only
 */'use strict';var SyntheticUIEvent=_dereq_(98);var getEventModifierState=_dereq_(112); /**
 ...
 * @typechecks static-only
 */'use strict';var SyntheticEvent=_dereq_(92);var getEventTarget=_dereq_(113); /**
 * @interface UIEvent
 * @see http://www.w3.org/TR/DOM-Level-3-Events/
...
try{this.closeAll(i+1);}catch(e){}}}}this.wrapperInitData.length=0;}};var Transaction={Mixin:Mixin, /**
   ...
   */OBSERVED_ERROR:{}};module.exports=Transaction;},{"143":143}],101:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
return [current].concat(next);}return [current,next];}module.exports=accumulateInto;},{"143":143}],103:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
}if(typeof value==='string'){value=value.trim();}return value+'px';}module.exports=dangerousStyleValue;},{"4":4}],105:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var assign=_dereq_(23);var warning=_dereq_(154); /**
...
return assign(newFn,fn);}return fn;}module.exports=deprecated;},{"154":154,"23":23}],106:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */function escapeTextContentForBrowser(text){return (''+text).replace(ESCAPE_REGEX,escaper);}module.exports=escapeTextContentForBrowser;},{}],107:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var ReactCurrentOwner=_dereq_(34);var ReactInstanceMap=_dereq_(62);var ReactMount=_dereq_(65);var invariant=_dereq_(143);var warning=_dereq_(154); /**
 ...
 */'use strict';var traverseAllChildren=_dereq_(126);var warning=_dereq_(154); /**
 ...
 */function flattenChildren(children){if(children==null){return children;}var result={};traverseAllChildren(children,flattenSingleChildIntoContext,result);return result;}module.exports=flattenChildren;},{"126":126,"154":154}],109:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * allocate an array).
 */var forEachAccumulated=function forEachAccumulated(arr,cb,scope){if(Array.isArray(arr)){arr.forEach(cb,scope);}else if(arr){cb.call(scope,arr);}};module.exports=forEachAccumulated;},{}],110:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
if(charCode>=32||charCode===13){return charCode;}return 0;}module.exports=getEventCharCode;},{}],111:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var getEventCharCode=_dereq_(110); /**
...
return translateToKey[nativeEvent.keyCode]||'Unidentified';}return '';}module.exports=getEventKey;},{"110":110}],112:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
return target.nodeType===3?target.parentNode:target;}module.exports=getEventTarget;},{}],114:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @return {?function}
 */function getIteratorFn(maybeIterable){var iteratorFn=maybeIterable&&(ITERATOR_SYMBOL&&maybeIterable[ITERATOR_SYMBOL]||maybeIterable[FAUX_ITERATOR_SYMBOL]);if(typeof iteratorFn==='function'){return iteratorFn;}}module.exports=getIteratorFn;},{}],115:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ExecutionEnvironment=_dereq_(129);var contentKey=null; /**
...
contentKey='textContent' in document.documentElement?'textContent':'innerText';}return contentKey;}module.exports=getTextContentAccessor;},{"129":129}],117:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks static-only
 */'use strict';var ReactCompositeComponent=_dereq_(33);var ReactEmptyComponent=_dereq_(54);var ReactNativeComponent=_dereq_(68);var assign=_dereq_(23);var invariant=_dereq_(143);var warning=_dereq_(154); // To avoid a cyclic dependency, we create the final class in this module
...
if("development"!=='production'){if(Object.preventExtensions){Object.preventExtensions(instance);}}return instance;}module.exports=instantiateReactComponent;},{"143":143,"154":154,"23":23,"33":33,"54":54,"68":68}],118:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ExecutionEnvironment=_dereq_(129);var useHasFeature;if(ExecutionEnvironment.canUseDOM){useHasFeature=document.implementation&&document.implementation.hasFeature&& // always returns true in newer browsers as per the standard.
...
isSupported=document.implementation.hasFeature('Events.wheel','3.0');}return isSupported;}module.exports=isEventSupported;},{"129":129}],119:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ReactElement=_dereq_(52);var invariant=_dereq_(143); /**
 ...
 * structure.
 */function onlyChild(children){!ReactElement.isValidElement(children)?"development"!=='production'?invariant(false,'onlyChild must be passed a children with exactly one child.'):invariant(false):undefined;return children;}module.exports=onlyChild;},{"143":143,"52":52}],121:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var escapeTextContentForBrowser=_dereq_(106); /**
 * Escapes attribute value to prevent scripting attacks.
 *
 * @param {*} value Value to escape.
 * @return {string} An escaped string.
 */function quoteAttributeValueForBrowser(value){return '"'+escapeTextContentForBrowser(value)+'"';}module.exports=quoteAttributeValueForBrowser;},{"106":106}],122:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
*/'use strict';var ReactMount=_dereq_(65);module.exports=ReactMount.renderSubtreeIntoContainer;},{"65":65}],123:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */ /* globals MSApp */'use strict';var ExecutionEnvironment=_dereq_(129);var WHITESPACE_TEST=/^[ \r\n\t\f]/;var NONVISIBLE_TEST=/<(!--|link|noscript|meta|script|style)[ \r\n\t\f\/>]/; /**
...
var textNode=node.firstChild;if(textNode.data.length===1){node.removeChild(textNode);}else {textNode.deleteData(0,1);}}else {node.innerHTML=html;}};}}module.exports=setInnerHTML;},{"129":129}],124:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var ExecutionEnvironment=_dereq_(129);var escapeTextContentForBrowser=_dereq_(106);var setInnerHTML=_dereq_(123); /**
 ...
 */'use strict';var ReactCurrentOwner=_dereq_(34);var ReactElement=_dereq_(52);var ReactInstanceHandles=_dereq_(61);var getIteratorFn=_dereq_(114);var invariant=_dereq_(143);var warning=_dereq_(154);var SEPARATOR=ReactInstanceHandles.SEPARATOR;var SUBSEPARATOR=':'; /**
 ...
 * @return {!number} The number of children in this subtree.
 */function traverseAllChildren(children,callback,traverseContext){if(children==null){return 0;}return traverseAllChildrenImpl(children,'',callback,traverseContext);}module.exports=traverseAllChildren;},{"114":114,"143":143,"154":154,"34":34,"52":52,"61":61}],127:[function(_dereq_,module,exports){ /**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';var assign=_dereq_(23);var emptyFunction=_dereq_(135);var warning=_dereq_(154);var validateDOMNesting=emptyFunction;if("development"!=='production'){ // This validation code was written based on the HTML5 parsing spec:
 ...
 * @typechecks
 */'use strict';var emptyFunction=_dereq_(135); /**
...
};module.exports=ExecutionEnvironment;},{}],130:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @param {string} string
 * @return {string}
 */function camelize(string){return string.replace(_hyphenPattern,function(_,character){return character.toUpperCase();});}module.exports=camelize;},{}],131:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var camelize=_dereq_(130);var msPattern=/^-ms-/; /**
 ...
 * @param {string} string
 * @return {string}
 */function camelizeStyleName(string){return camelize(string.replace(msPattern,'ms-'));}module.exports=camelizeStyleName;},{"130":130}],132:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var isTextNode=_dereq_(145); /*eslint-disable no-bitwise */ /**
 ...
 * @typechecks
 */'use strict';var toArray=_dereq_(153); /**
 ...
 * @param {*} obj
 * @return {array}
 */function createArrayFromMixed(obj){if(!hasArrayNature(obj)){return [obj];}else if(Array.isArray(obj)){return obj.slice();}else {return toArray(obj);}}module.exports=createArrayFromMixed;},{"153":153}],134:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */ /*eslint-disable fb-www/unsafe-html*/'use strict';var ExecutionEnvironment=_dereq_(129);var createArrayFromMixed=_dereq_(133);var getMarkupWrap=_dereq_(139);var invariant=_dereq_(143); /**
 ...
 */'use strict';var emptyObject={};if("development"!=='production'){Object.freeze(emptyObject);}module.exports=emptyObject;},{}],137:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
try{node.focus();}catch(e){}}module.exports=focusNode;},{}],138:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';function getActiveElement() /*?DOMElement*/{if(typeof document==='undefined'){return null;}try{return document.activeElement||document.body;}catch(e){return document.body;}}module.exports=getActiveElement;},{}],139:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */ /*eslint-disable fb-www/unsafe-html */'use strict';var ExecutionEnvironment=_dereq_(129);var invariant=_dereq_(143); /**
 ...
 * @param {string} string
 * @return {string}
 */function hyphenate(string){return string.replace(_uppercasePattern,'-$1').toLowerCase();}module.exports=hyphenate;},{}],142:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var hyphenate=_dereq_(141);var msPattern=/^ms-/; /**
 ...
 * @param {string} string
 * @return {string}
 */function hyphenateStyleName(string){return hyphenate(string).replace(msPattern,'-ms-');}module.exports=hyphenateStyleName;},{"141":141}],143:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
throw error;}};module.exports=invariant;},{}],144:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';function isNode(object){return !!(object&&(typeof Node==='function'?object instanceof Node:(typeof object==="undefined"?"undefined":_typeof(object))==='object'&&typeof object.nodeType==='number'&&typeof object.nodeName==='string'));}module.exports=isNode;},{}],145:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var isNode=_dereq_(144); /**
 * @param {*} object The object to check.
 * @return {boolean} Whether or not the object is a DOM text node.
 */function isTextNode(object){return isNode(object)&&object.nodeType==3;}module.exports=isTextNode;},{"144":144}],146:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @param {object} obj
 * @return {object}
 */var keyMirror=function keyMirror(obj){var ret={};var key;!(obj instanceof Object&&!Array.isArray(obj))?"development"!=='production'?invariant(false,'keyMirror(...): Argument must be an object.'):invariant(false):undefined;for(key in obj){if(!obj.hasOwnProperty(key)){continue;}ret[key]=key;}return ret;};module.exports=keyMirror;},{"143":143}],147:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */"use strict";var keyOf=function keyOf(oneKeyObj){var key;for(key in oneKeyObj){if(!oneKeyObj.hasOwnProperty(key)){continue;}return key;}return null;};module.exports=keyOf;},{}],148:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @param {*} context
 * @return {?object}
 */function mapObject(object,callback,context){if(!object){return null;}var result={};for(var name in object){if(hasOwnProperty.call(object,name)){result[name]=callback.call(context,object[name],name,object);}}return result;}module.exports=mapObject;},{}],149:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @param {function} callback
 * @return {function}
 */function memoizeStringOnly(callback){var cache={};return function(string){if(!cache.hasOwnProperty(string)){cache[string]=callback.call(this,string);}return cache[string];};}module.exports=memoizeStringOnly;},{}],150:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var ExecutionEnvironment=_dereq_(129);var performance;if(ExecutionEnvironment.canUseDOM){performance=window.performance||window.msPerformance||window.webkitPerformance;}module.exports=performance||{};},{"129":129}],151:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 * @typechecks
 */'use strict';var performance=_dereq_(150);var curPerformance=performance; /**
 * Detect if we can use `window.performance.now()` and gracefully fallback to
 * `Date.now()` if it doesn't exist. We need to support Firefox < 15 for now
 * because of Facebook's testing infrastructure.
 */if(!curPerformance||!curPerformance.now){curPerformance=Date;}var performanceNow=curPerformance.now.bind(curPerformance);module.exports=performanceNow;},{"150":150}],152:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
var bHasOwnProperty=hasOwnProperty.bind(objB);for(var i=0;i<keysA.length;i++){if(!bHasOwnProperty(keysA[i])||objA[keysA[i]]!==objB[keysA[i]]){return false;}}return true;}module.exports=shallowEqual;},{}],153:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
var ret=Array(length);for(var ii=0;ii<length;ii++){ret[ii]=obj[ii];}return ret;}module.exports=toArray;},{"143":143}],154:[function(_dereq_,module,exports){ /**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
throw new Error(message);}catch(x){}}};}module.exports=warning;},{"135":135}]},{},[1])(1);});
"use strict";
...
var D3AppModel = D3AppModel || {
  itemTypes: [],
  characters: ['Barb', 'DH', 'Monk', 'WD', 'Wiz', 'Cru'],
  activeCharacters: ['Barb', 'DH', 'Monk', 'WD', 'Wiz', 'Cru'],
  searchCache: ''
};
'use strict';
...
var D3AppController = D3AppController || function (GLOBAL) {
  ...
  return {
    ...
    getItemTypes: function getItemTypes(items) {
      var types = [];
...
var DropChanceSixColumns = function (_React$Component) {
  _inherits(DropChanceSixColumns, _React$Component);

  function DropChanceSixColumns() {
    _classCallCheck(this, DropChanceSixColumns);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DropChanceSixColumns).apply(this, arguments));
  }

  _createClass(DropChanceSixColumns, [{
    key: 'render',
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'u-cf' },
        self.props.activeCharacters.map(function (x) {
  ...
  return DropChanceSixColumns;
}(React.Component);

var KadalaChanceSixColumns = function (_React$Component2) {
  _inherits(KadalaChanceSixColumns, _React$Component2);

  function KadalaChanceSixColumns() {
    _classCallCheck(this, KadalaChanceSixColumns);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(KadalaChanceSixColumns).apply(this, arguments));
  }

  _createClass(KadalaChanceSixColumns, [{
    key: 'render',
    value: function render() {
      var self = this;
      return React.createElement(
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'u-textBold u-c-kadala' },
                    x
                  ),
                  ' - ',
                  kadalaChance,
                ...
                React.createElement(
                  'div',
                  null,
                  self.props.item[x + 'ShardCost'],
                  ' / ',
                  D3AppController.formatNumber(+self.props.item[x + 'ShardCost'].replace(/,/g, '') * 1.609)
                )
              )
            );
          }
  ...
  return KadalaChanceSixColumns;
}(React.Component);

var BreathSixColumns = function (_React$Component3) {
  _inherits(BreathSixColumns, _React$Component3);

  function BreathSixColumns() {
    _classCallCheck(this, BreathSixColumns);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(BreathSixColumns).apply(this, arguments));
  }

  _createClass(BreathSixColumns, [{
    key: 'render',
    value: function render() {
      var self = this;
      return React.createElement(
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    { className: 'u-textBold u-c-deaths' },
                    x
                  )
                ),
                React.createElement(
                  ...
                  breathCost,
                  ' / ',
                  D3AppController.formatNumber(+breathCost.replace(/,/g, '') * 1.609)
                )
              )
            );
          }
...
var D3AppRowContentsExpanded = function (_React$Component) {
  _inherits(D3AppRowContentsExpanded, _React$Component);

  function D3AppRowContentsExpanded() {
    _classCallCheck(this, D3AppRowContentsExpanded);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3AppRowContentsExpanded).apply(this, arguments));
  }

  _createClass(D3AppRowContentsExpanded, [{
    key: 'render',
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { className: 'four columns u-ph-10' },
              React.createElement(
                'div',
                { className: 'Item-label u-mb-5' },
                'Drop Chance:'
              ),
              React.createElement(DropChanceSixColumns, { item: item, activeCharacters: activeCharacters }),
              React.createElement(
                'div',
            ...
            React.createElement(
              ...
              React.createElement(KadalaChanceSixColumns, { item: item, activeCharacters: activeCharacters }),
              React.createElement(
                'div',
                { className: 'Item-labelExplanation u-mb-10 u-cb u-borderTopWhite' },
                React.createElement(
                  'span',
                  { className: 'u-c-tan' },
                  'On average, you can expect to see the item once per this amount of ',
                  React.createElement(
                    'span',
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'Item-labelExplanation u-mb-10' },
                React.createElement(
                  'span',
                  { className: 'u-c-tan' },
                  'On average, you can expect to see the item once per this amount of ',
...
var D3AppRowContents = function (_React$Component) {
  _inherits(D3AppRowContents, _React$Component);

  function D3AppRowContents() {
    _classCallCheck(this, D3AppRowContents);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3AppRowContents).apply(this, arguments));
  }

  _createClass(D3AppRowContents, [{
    key: 'render',
    value: function render() {
      var item = this.props.item,
          activeCharacters = this.props.activeCharacters,
      ...
      return React.createElement(
        'div',
        { className: 'row D3TableContainer-tableRow' },
        React.createElement(
          'div',
          ...
          React.createElement(
            ...
            { className: 'Item-imageContainer' },
            React.createElement('div', { className: 'Item-imageBackground Item-imageBackground--' + item.displayColor }),
            React.createElement('div', { className: 'Item-image', style: { backgroundImage: 'url(http://media.blizzard.com/d3/icons/items/small/' + item.icon + '.png)' } })
          ),
          React.createElement(
            'div',
            { className: 'Item-itemDescription' },
...
var D3AppRowGroup = function (_React$Component) {
  _inherits(D3AppRowGroup, _React$Component);

  function D3AppRowGroup() {
    _classCallCheck(this, D3AppRowGroup);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3AppRowGroup).apply(this, arguments));
  }

  _createClass(D3AppRowGroup, [{
    key: 'render',
    value: function render() {
      var self = this,
          ...
          filteredItems = self.props.items.filter(function (y) {
        return y.itemType == itemType && activeCharacters.some(function (z) {
          return y['is' + z + 'Loot'] == 1;
        });
      }),
          groupHeader = filteredItems.length ? React.createElement(
        'div',
        { className: 'D3TableContainer-sectionHeader' },
        itemType
      ) : null;

      return React.createElement(
        'div',
        { key: D3AppController.generateUUID() },
        groupHeader,
        filteredItems.map(function (item, i) {
          return React.createElement(D3AppRow, { expandedItems: expandedItems, item: item, activeCharacters: activeCharacters, key: D3AppController.generateUUID() });
        })
      );
    }
  }]);

  return D3AppRowGroup;
}(React.Component);

var D3AppRow = function (_React$Component2) {
  _inherits(D3AppRow, _React$Component2);

  function D3AppRow(props) {
    _classCallCheck(this, D3AppRow);

    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(D3AppRow).call(this, props));
  ...
  _createClass(D3AppRow, [{
    ...
    value: function render() {
      ...
      if (this.state.expanded) {
        return React.createElement(D3AppRowContentsExpanded, { handlers: handlers, item: item, activeCharacters: activeCharacters, determineCharacters: determineCharacters });
      } else {
        return React.createElement(D3AppRowContents, { handlers: handlers, item: item, activeCharacters: activeCharacters, determineCharacters: determineCharacters });
      }
    }
  }]);
...
var D3Paginator = function (_React$Component) {
  _inherits(D3Paginator, _React$Component);

  function D3Paginator() {
    _classCallCheck(this, D3Paginator);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3Paginator).apply(this, arguments));
  }

  _createClass(D3Paginator, [{
    key: 'handleClick',
    ...
    value: function render() {
      ...
      while (i <= totalPages) {
        pageNumbers.push(React.createElement(
          ...
          React.createElement(
            'a',
            { className: 'D3Paginator-pageNumberLink' + (i == currentPage ? ' is-active' : ''), onClick: this.handleClick.bind(this), 'data-page': i },
            i
          )
        ));
        i++;
...
var D3AppControlPanel = function (_React$Component2) {
  _inherits(D3AppControlPanel, _React$Component2);

  function D3AppControlPanel() {
    _classCallCheck(this, D3AppControlPanel);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3AppControlPanel).apply(this, arguments));
  }

  _createClass(D3AppControlPanel, [{
    key: 'render',
    value: function render() {
      return React.createElement(
        'div',
        { className: 'D3ControlPanel' },
        React.createElement(
          'div',
          { className: 'row u-zi-5' },
          React.createElement(
            'div',
            { className: 'three columns' },
            React.createElement(D3Search, null)
          ),
          React.createElement(
            'div',
            { className: 'six columns' },
            React.createElement(D3CharacterList, { activeCharacters: this.props.activeCharacters })
          ),
          React.createElement(
            'div',
            { className: 'three columns' },
            React.createElement(D3ItemTypeDropDown, { selectedType: this.props.selectedType, itemTypes: this.props.itemTypes })
          )
        )
      );
    }
  ...
  return D3AppControlPanel;
}(React.Component);

var D3Search = function (_React$Component3) {
  _inherits(D3Search, _React$Component3);

  function D3Search() {
    _classCallCheck(this, D3Search);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3Search).apply(this, arguments));
  }

  _createClass(D3Search, [{
    key: 'clearIfEmptyOrSubmit',
    value: function clearIfEmptyOrSubmit(e) {
      if (e.keyCode == 13) {
    ...
    key: 'updateSearchCache',
    value: function updateSearchCache(e) {
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement('input', { type: 'text', className: 'D3ControlPanel-searchInput', ref: 'searchInput', onKeyUp: this.clearIfEmptyOrSubmit }),
        React.createElement(
          'button',
          { className: 'D3ControlPanel-searchButton', onClick: this.updateSearchCache.bind(this) },
          'Search'
        )
      );
    }
...
var D3CharacterList = function (_React$Component4) {
  _inherits(D3CharacterList, _React$Component4);

  function D3CharacterList() {
    _classCallCheck(this, D3CharacterList);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3CharacterList).apply(this, arguments));
  }

  _createClass(D3CharacterList, [{
    key: 'toggleChar',
    value: function toggleChar(e) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'D3CharacterList' },
        React.createElement(
          'div',
          { className: 'row' },
          D3AppModel.characters.map(function (x) {
            return React.createElement(
              'div',
              { className: 'two columns u-textCenter', key: D3AppController.generateUUID() },
              React.createElement(
                'a',
                { onClick: self.toggleChar, 'data-char': x, className: 'D3CharacterList-portrait D3CharacterList-portrait--' + x + (self.props.activeCharacters.indexOf(x) > -1 ? ' is-active' : '') },
                React.createElement(
                  'span',
                  { className: 'D3CharacterList-portraitTitle' },
                  x
                )
              )
            );
  ...
  return D3CharacterList;
}(React.Component);

var D3ItemTypeDropDown = function (_React$Component5) {
  _inherits(D3ItemTypeDropDown, _React$Component5);

  function D3ItemTypeDropDown() {
    _classCallCheck(this, D3ItemTypeDropDown);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(D3ItemTypeDropDown).apply(this, arguments));
  }

  _createClass(D3ItemTypeDropDown, [{
    key: 'fireDropDownChange',
    value: function fireDropDownChange(e) {
      var target = e.target;
    ...
    value: function render() {
      ...
      return React.createElement(
        'select',
        { className: 'D3ControlPanel-dropDown', onChange: this.fireDropDownChange, defaultValue: 'all', value: self.props.selectedType },
        React.createElement(
          'option',
          { key: D3AppController.generateUUID(), value: 'all' },
          'All Item Types'
        ),
        itemTypes.map(function (x) {
          return React.createElement(
            'option',
            { key: D3AppController.generateUUID(), value: x },
            x
          );
        })
      );
...
var D3App = function (_React$Component) {
  _inherits(D3App, _React$Component);

  //getInitialState

  function D3App(props) {
    _classCallCheck(this, D3App);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(D3App).call(this, props));
  ...
  _createClass(D3App, [{
    ...
    value: function componentDidMount() {
      var self = this,
          types = self.props.items.map(function (x) {
        return x.itemType;
      });
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement(D3AppControlPanel, { activeCharacters: activeCharacters, selectedType: this.state.selectedType, itemTypes: this.state.itemTypes }),
        React.createElement(
          'div',
          { className: 'D3TableContainer-tableHeaders' },
          React.createElement(
            'div',
            { className: 'row' },
            React.createElement(
              'div',
              { className: 'three columns D3TableContainer-columnHeader' },
              'Item'
            ),
            React.createElement(
              'div',
              { className: 'two columns D3TableContainer-columnHeader' },
              'Alt Types'
            ),
            React.createElement(
              'div',
              { className: 'one columns D3TableContainer-columnHeader' },
              'Classes'
            ),
            React.createElement(
              'div',
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'four columns D3TableContainer-columnHeader' },
                  'Drop'
                ),
                React.createElement(
                  'div',
                  { className: 'four columns D3TableContainer-columnHeader u-c-kadala' },
                  'Kadala'
                ),
                React.createElement(
                  'div',
                  { className: 'four columns D3TableContainer-columnHeader u-c-deaths' },
                  'Breath (Cube)'
                )
              )
            )
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'D3TableContainer-table' },
            self.state.itemTypes.map(function (x) {
              if (self.props.items.some(function (y) {
                return y.itemType == x;
              })) {
                return React.createElement(D3AppRowGroup, { itemType: x, items: items, activeCharacters: activeCharacters, key: D3AppController.generateUUID() });
              }
            })
          ),
          paginator
